...
namespace ManagementSystem.Controllers
{
    ...
    public class EnrollmentController : Controller
    {
        ...
        {
            var enrollments = db.Enrollments.Include(e => e.Course).Include(e => e.Trainer);
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,CourseID,TrainerID")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,CourseID,TrainerID")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
